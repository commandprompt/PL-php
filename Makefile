...
REGRESS = init base shared trigger spi raise cargs pseudo srf out varnames validator compat txn evttrig subxact modules cursor arrays coverage cookbook pgerror
